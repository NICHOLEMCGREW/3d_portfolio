import HeroTitle from "./HeroTitle" // Adjust the path as per your project structure
import LinkButton from "./LinkButton" // Adjust the path as per your project structure
import DownloadCVButton from "./DownloadCVButton" // Adjust the path as per your project structure
	...
	return (
		<section className="h-screen flex items-center lg:pt-24 sm:pt-16">
			<div className="lg:ml-12 grid grid-cols-1 sm:grid-cols-12 mx-auto w-full">
				{/* Hero Text Section */}
				<div className="col-span-8 place-self-center text-center sm:text-left justify-self-start px-4 sm:px-8 lg:px-20 pt-6">
					<div>
						<HeroTitle />
					</div>
